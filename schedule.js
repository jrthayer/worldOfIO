...
export function createSchedule(showArray) {
    ...
    let dayContainerExtra = document.createElement("div");
    let dayContainer = document.createElement("div");
    dayContainerExtra.classList.add("schedule-carousel");
    dayContainer.classList.add("schedule-carousel-days");
    let leftBtn = document.createElement("button");
    let rightBtn = document.createElement("button");
    dayContainerExtra.appendChild(leftBtn);
    dayContainerExtra.appendChild(rightBtn);
    dayContainerExtra.appendChild(dayContainer);
    ...
    container.appendChild(dayContainerExtra);
...
export function createDaySchedule(day, daySchedule) {
    ...
    for (let x = 0; x < daySchedule.length; x++) {
        ...
        let showString = daySchedule[x][1];
        let showNameFormatted = showString.replace(/\s/g, "");
